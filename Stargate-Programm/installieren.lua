...
function Funktionen.installieren(versionTyp)
  ...
  local update = {}
  loadfile("/bin/pastebin.lua")("get", "-f", "63v6mQtK")
  ...
  update[11]= wget("-f", Funktionen.Pfad(versionTyp) .. "stargate/sprache/ersetzen.lua",      "/update/stargate/sprache/ersetzen.lua")
  for i = 1, 11 do
    if update[i] then
      updateKomplett = true
    else
