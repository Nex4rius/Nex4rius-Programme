...
local sprachen = {
  ...
  aktualisierenNein         = "\n" .. "answer: ",
  aktualisierenJetzt        = "\n" .. "\n" .. "\n" .. "updating..." .. "\n",
  aktualisierenGleich       = "nexDHD will be updated when the Stargate is idle.",
  laden                     = "\n" .. "loading...",
  ja                        = "yes",
  nein                      = "no",
  hilfe                     = "help",
  ...
  StargateNichtKomplett     = "Stargate interface detected\nStargate is not functional\nIt's either incomplete or not connected to the interface",
  ...
  IDC_blockiert             = "Too many failed attempts - IDC blocked",
  Port                      = "default 645",
