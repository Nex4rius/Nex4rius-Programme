...
local sprachen = {
  ...
  RedstoneOrange            = "orange: Chevron aktiviert",
  versionName               = "Version: ",
  fehlerName                = "<FEHLER>",
  ...
  StargateNichtKomplett     = "Stargate Interface erkannt\nStargate ist funktionsunfähig\nEs ist entweder nicht komplett oder nicht mit dem Interface verbunden",
