...
if standard then
  ...
  standard = {autoclosetime = 60, IDC = "", RF = false, Sprache = "", side = "unten", autoUpdate = true, StargateName = "", Port = 645, Reichweite = 30, debug = false, control = "On", installieren = false, Theme = "normal", kein_senden = false}
end
