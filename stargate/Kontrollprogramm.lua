...
function zeigeStatus()
  aktualisiereStatus()
        zeigeHier(1, 1, "control hier " .. control)
        zeigeHier(1, 2, "iriscontrol hier " .. iriscontrol)
        zeigeHier(1, 3, "wormhole hier " .. wormhole)
        zeigeHier(1, 4, "state hier " .. state)
        zeigeHier(1, 5, "iris hier " .. iris)
